      ...
      <div className="flex justify-around snap-center align-middle max-sm:flex-col">
        ...
        <div className="m-4 max-w-[70%]">
          ...
          <p className="text-lg font-light ">
            Introducing Quantumplators, the pioneering Quantum Computing Special
            Team at VIT Chennai.
            <br />
      ...
      <div className="flex snap-center align-middle justify-around max-sm:flex-col">
        ...
        <div className="m-4  max-w-[70%] ">
          ...
          <p className="text-lg font-light">
            ...
            both simulators and real quantum hardware. Qiskit includes tools for
            building quantum circuits, simulating quantum systems, and
